...
<body>
  ...
  <div class="page-banner overlay-dark bg-image" style="background-image: url(assets2/img/bg_image_1.jpg);">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 wow fadeInUp">
          <h1 class="text-center mb-3">Welcome to Lifeline</h1>
          <div class="text-lg">
            <p>A scheduler of lifeline, for better and greater management of Health.</p>
