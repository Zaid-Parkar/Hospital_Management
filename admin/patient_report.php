									...
									<form method="post" enctype="multipart/form-data">
										...
										<div class="form-input py-2">
											<div class="form-group">
												<input type="text" class="form-control" placeholder="Enter patientid" name="name">
											</div>
											<div class="form-group">
												<input type="text" class="form-control" placeholder="Enter caseid" name="caseid">
											</div>
											<div class="form-group">
